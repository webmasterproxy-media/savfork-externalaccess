...
if(empty($reshook)){ 
    ...
    {
        $link = $context->getRootUrl('project');
        printService($langs->trans('project'),'fa-pencil',$link); // desc : $langs->trans('QuotationsDesc')
    }
      ...
      //if($conf->global->EACCESS_ACTIVATE_FICHINTER && !empty($user->rights->externalaccess->view_propals))
    {
        $link = $context->getRootUrl('contracts');
        printService($langs->trans('contracts'),'fa-pencil',$link); // desc : $langs->trans('QuotationsDesc')
    }
     ...
     //if($conf->global->EACCESS_ACTIVATE_FICHINTER && !empty($user->rights->externalaccess->view_propals))
    {
        $link = $context->getRootUrl('agenda');
        printService($langs->trans('agenda'),'fa-pencil',$link); // desc : $langs->trans('QuotationsDesc')
    }
