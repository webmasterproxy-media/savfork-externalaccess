...
{	
	...
	//if($conf->global->EACCESS_ACTIVATE_PROPALS && !empty($user->rights->externalaccess->view_propals))
    {
        $Tmenu['ticket'] = array(
            'id' => 'ticket',
            'rank' => 10,
            'url' => $context->getRootUrl('ticket'),
            'name' => $langs->trans('EALINKNAME_ticket'),
        );
    }
    ...
    //if($conf->global->EACCESS_ACTIVATE_PROPALS && !empty($user->rights->externalaccess->view_propals))
    {
        $Tmenu['agenda'] = array(
            'id' => 'agenda',
            'rank' => 10,
            'url' => $context->getRootUrl('agenda'),
            'name' => $langs->trans('EALINKNAME_agenda'),
        );
    }
	...
	//if($conf->global->EACCESS_ACTIVATE_PROPALS && !empty($user->rights->externalaccess->view_propals))
    {
        $Tmenu['contracts'] = array(
            'id' => 'contracts',
            'rank' => 10,
            'url' => $context->getRootUrl('contracts'),
            'name' => $langs->trans('EALINKNAME_contracts'),
        );
    }
